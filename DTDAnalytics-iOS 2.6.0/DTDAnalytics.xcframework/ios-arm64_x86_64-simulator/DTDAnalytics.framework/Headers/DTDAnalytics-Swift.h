...
SWIFT_CLASS("_TtC12DTDAnalytics24DTDRemoteConfigChangeKey")
...
@interface DTDRemoteConfigChangeKey (SWIFT_EXTENSION(DTDAnalytics))
...
SWIFT_CLASS("_TtC12DTDAnalytics21DTDRemoteConfigUpdate")
