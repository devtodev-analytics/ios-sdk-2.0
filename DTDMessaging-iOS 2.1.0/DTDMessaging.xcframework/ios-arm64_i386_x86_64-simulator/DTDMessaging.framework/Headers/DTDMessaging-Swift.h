...
#ifndef DTDMESSAGING_SWIFT_H
#define DTDMESSAGING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DTDMessaging",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

enum DTDActionType : NSInteger;

SWIFT_CLASS("_TtC12DTDMessaging15DTDActionButton")
...
SWIFT_CLASS("_TtC12DTDMessaging27DTDMediaAttachmentExtension") SWIFT_AVAILABILITY(ios,introduced=10.0)
...
SWIFT_CLASS("_TtC12DTDMessaging10DTDMessage")
...
SWIFT_CLASS("_TtC12DTDMessaging12DTDMessaging")
@interface DTDMessaging : NSObject
+ (void)startPushService;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nullable apnsToken;)
+ (NSString * _Nullable)apnsToken SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP12DTDMessaging20DTDMessagingDelegate_")
@protocol DTDMessagingDelegate
@optional
- (void)didRegisterForRemoteNotificationsWith:(NSString * _Nonnull)deviceToken;
...
SWIFT_CLASS("_TtC12DTDMessaging22DTDNotificationOptions")
